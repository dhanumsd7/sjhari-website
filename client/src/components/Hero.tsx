...
export function Hero() {
  ...
  return (
    <>
      <Helmet>
        <title>SJ Hari Painting & Building Maintenance | Ammandivilai</title>
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 pt-32">
          ...
          >
            <Button
              className="bg-white !text-black h-12 px-8 rounded-full font-bold shadow-lg hover:scale-105 transition flex items-center gap-2"
          ...
          <p className="mt-6 text-white/70 text-sm font-medium tracking-wide max-w-xl">
            One call is all it takes — we handle everything from start to
            finish.
          </p>
        </div>
      </section>
