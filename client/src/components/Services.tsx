...
export function Services() {
  const services = [
    ...
    { title: "Sprat Painting", desc: "Specialized texture and protective coating applications." },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              <Card className="h-full border-0 shadow-sm shadow-slate-200 bg-white hover:shadow-xl transition-all duration-300 rounded-3xl overflow-hidden group">
                <CardContent className="p-10 flex flex-col h-full min-h-[220px]">
                  ...
                  <h4 className="text-2xl font-bold text-slate-900 mb-3 group-hover:text-primary transition-colors">{service.title}</h4>
                  <p className="text-slate-500 font-medium mb-8 flex-grow leading-relaxed">{service.desc}</p>
